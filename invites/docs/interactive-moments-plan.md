...
### Phase E — the Occasion shelf and the storyline demo
church-doors, baby, cheers, and the occasion variants of gift, cake and scroll, offered by occasion; the demo invitation set up with her storyline (seal → camera → curtains → church doors → scratch) so it can be shown on a phone end to end.
