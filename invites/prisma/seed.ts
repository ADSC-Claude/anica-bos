...
async function main() {
  ...
  Object.assign(content.dressCode!, { attire: 'formal', attireText: 'We kindly encourage our guests to wear elegant formal attire.', gentsColors: ['#2a2726', '#c8b596', '#59604a', '#e8dfcf'], gentsItems: ['suit', 'coat', 'longSleeves', 'dressShoes'], gentsNote: 'Tie is optional.', ladiesColors: ['#d9c3a5', '#9daa8f', '#d9a9a9', '#8a5a3c', '#e9dcc3'], ladiesItems: ['longGown', 'cocktail', 'separates'], ladiesNote: 'We encourage earthy, neutral and muted tones.', colors: ['#efe6dc', '#d9c3a5', '#b8a898', '#d9a9a9', '#8c9a82', '#5b6b4e', '#6b4a35', '#a8785a', '#5a3d2b'], paletteNote: 'You may choose from this palette or similar shades.', avoid: ['white', 'bright', 'casual', 'sports', 'slippers', 'prints'], sponsorsAttire: 'Champagne gown / Barong Tagalog', entourageAttire: 'Sage green', note: '' });
