...
async function main() {
  ...
  await prisma.addOn.createMany({
    data: [
      ...
      { code: 'PRIORITY', name: 'Priority (2 working days)', description: 'Your invitation is finished in two working days instead of the usual five to a week. Fewer revision rounds come with it: there is limited time to encode, so there is minimal chance to revise. The steadier of the two promises, and the one we would suggest for a big build.', priceCents: 200000, sortOrder: 6 },
