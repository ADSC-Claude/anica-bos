...
async function main() {
  ...
  Object.assign(content.dressCode!, { attire: 'formal', attireText: 'We kindly encourage our guests to wear elegant formal attire.', gentsColors: ['#2a2726', '#c8b596', '#59604a', '#e8dfcf'], gentsItems: ['suit', 'coat', 'longSleeves', 'dressShoes'], gentsNote: 'Tie is optional.', ladiesColors: ['#c9ad86', '#9daa8f', '#d9a9a9', '#8a5a3c', '#a67c6d'], ladiesItems: ['longGown', 'cocktail', 'separates'], ladiesNote: 'We encourage earthy, neutral and muted tones.', colors: ['#d9c3a5', '#b8a898', '#d9a9a9', '#8c9a82', '#5b6b4e', '#6b4a35', '#a8785a', '#5a3d2b'], paletteNote: 'You may choose from this palette or similar shades.', avoid: ['white', 'bright', 'casual', 'sports', 'slippers', 'prints'], sponsorsAttire: 'Champagne gown / Barong Tagalog', entourageAttire: 'Sage green', note: '' });
