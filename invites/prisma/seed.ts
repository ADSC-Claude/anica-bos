...
async function main() {
  ...
  await prisma.addOn.createMany({
    data: [
      ...
      { code: 'PRIORITY', name: 'Priority (2 to 3 working days)', description: 'Your invitation is finished in two to three working days instead of the usual seven to ten. Fewer revision rounds come with it: there is limited time to encode, so there is minimal chance to revise. Signature and Luxury — those builds carry per-guest links, seating and a programme, which is more than one night of work however much anyone wants it tomorrow.', priceCents: 200000, sortOrder: 6 },
