  ...
  return (
    <>
      ...
      <p className="mb-3 text-xs text-[color:var(--color-ink-500)]">
        {confirms
          ? 'Your package writes back to every guest who accepts and leaves an e-mail address, confirming their seats, at no charge. Guests who decline are not written to. The e-mail blast below is free too. An SMS blast is bought separately — texts are charged by the gateway, per message.'
          : 'The e-mail blast below is free. An SMS blast is bought separately — texts are charged by the gateway, per message. A confirmation e-mail to every guest who accepts comes with the Luxury package.'}
      </p>
