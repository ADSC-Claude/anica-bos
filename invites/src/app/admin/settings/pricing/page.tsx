    ...
    <>
      ...
      <div className="card overflow-x-auto">
        <table className="data">
          <thead><tr><th>Package</th><th>Name / tagline</th><th>Price ₱</th><th>+ DFY ₱</th><th>+ Priority ₱</th><th>Revision rounds</th><th>Validity days</th><th>Active</th><th /></tr></thead>
          <tbody>
            {packages.map((p) => (
              <tr key={p.id}>
                ...
                <td><input form={`pkg-${p.id}`} name="rounds" type="number" defaultValue={p.revisionRounds} className="field w-20" /></td>
