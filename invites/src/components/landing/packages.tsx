...
const HIGHLIGHTS: Record<Tier, string[]> = {
  BASIC: ['1 design from the Basic set', 'Your own colours, in the design’s own fonts', 'Cover, countdown, ceremony & reception with Maps + Waze', 'Dress code with motif swatches', '1 cover photo', 'Simple RSVP form', '3 edits after publish · link valid 30 days after'],
