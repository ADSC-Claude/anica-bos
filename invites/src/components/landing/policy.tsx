  ...
  if (kind === 'privacy') {
    return (
      <div className="prose-site mt-6 text-[color:var(--color-ink-700)]">
        ...
        <p><b>Your rights under RA 10173.</b> You may ask for a copy of your data, correct it, or have it deleted, and you do not have to ask us to do either. <a href="/account/privacy">Your data</a>, in your dashboard, downloads everything we hold about you in one file — your account, your orders, every invitation and every guest list — and deletes all of it on request. If you would rather we did it for you, message us at {s['business.email']} or on Messenger.</p>
        <p><b>What deletion leaves behind.</b> Everything personal goes: invitations, guest lists, RSVPs, guestbook messages, photos and support conversations, immediately and permanently. The order and payment records stay, because the law requires a business to keep records of what it sold for ten years — but your name, email and phone number are removed from them and the account can no longer be signed into.</p>
