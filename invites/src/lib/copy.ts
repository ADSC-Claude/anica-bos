...
const PHRASES = {
  ...
  'guestbook.openBook': { en: 'Read all {n} in the book', tl: 'Basahin lahat ng {n} sa aklat' },
  'guestbook.closeBook': { en: 'Show fewer', tl: 'Bawasan' },
  'guestbook.opening': { en: 'Opening the book…', tl: 'Binubuksan ang aklat…' },
  'guestbook.bookFailed': { en: 'The book would not open. Tap to try again.', tl: 'Hindi nabuksan ang aklat. Pindutin para subukan muli.' },
