...
const PHRASES = {
  ...
  'guestbook.showAll': { en: 'Show all messages', tl: 'Tingnan lahat ng mensahe' },
  'guestbook.oneMessage': { en: 'One message', tl: 'Isang mensahe' },
  'guestbook.someMessages': { en: '{n} messages', tl: '{n} na mensahe' },
  'guestbook.backToInvitation': { en: 'Back to the invitation', tl: 'Bumalik sa imbitasyon' },
