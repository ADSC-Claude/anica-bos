...
const SECTION_DEFS: SectionDef[] = [
  ...
  },
  {
    ...
    minTier: 'STANDARD',
    fields: () => [
      text('song', 'Your song', { placeholder: 'e.g. Ikaw — Yeng Constantino, or a Spotify / YouTube link', hint: 'The title and artist, or paste a link from Spotify or YouTube. A song cannot stream from Spotify or YouTube behind a page, so what plays is a file: upload yours below, or name the song here and our team prepares the file on a Done-For-You order.', wide: true }),
      ...
      audio('url', 'Your own audio file (optional)', { hint: 'MP3 or M4A, up to 20 MB. This is the file that plays: without it the page stays silent, whatever song you named above. On a Done-For-You order our team adds it for you.' }),
    ],
  },
  {
    key: 'guestbook',
