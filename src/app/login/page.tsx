    ...
    <main className="flex min-h-dvh items-center justify-center bg-gradient-to-b from-sand-100 to-sand-50 px-4 py-10">
      <div className="w-full max-w-sm">
        <div className="mb-6 text-center">
          <div className="mx-auto mb-3 flex h-14 w-14 items-center justify-center rounded-2xl bg-moss-600 text-2xl text-white">
            ✿
          </div>
          <h1 className="font-display text-2xl font-semibold text-moss-800">ANICA Wellness Spa</h1>
        ...
        {showDemo && (
          <div className="card-pad mt-4 text-xs text-moss-600">
            <p className="mb-2 font-semibold uppercase tracking-wide text-moss-500">
            ...
            <p className="mt-2 text-moss-400">
